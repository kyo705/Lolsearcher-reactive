...
public class BeanNameConstants {
    ...
    public static final String TOO_MANY_REQUESTS_ENTITY_NAME = "tooManyRequestsEntity";
    public static final String INTERNAL_SERVER_ERROR_ENTITY_NAME = "internalServerErrorEntity";
    public static final String BAD_REQUEST_ENTITY_NAME = "badRequestErrorEntity";
}
